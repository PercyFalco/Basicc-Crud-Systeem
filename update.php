      ...
      <div class="col-6">
        <form action="./update_script.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="infix" aria-describedby="infixHelp" placeholder="Invoer tussenvoegsel" name="infix" value=" <?php echo $record ["infix"]; ?> ">

          </div>
          <div class="form-group">
            <label for="lastname">Achternaam</label>
            <input type="text" class="form-control" id="lastname" aria-describedby="lastnameHelp" placeholder="achternaam" name="lastname" value=" <?php echo $record ["lastname"]; ?> ">
